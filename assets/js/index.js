...
// tipoComicCharacter.addEventListener('change', ()=> {
//     filterComicCharacter();
// });

// function filterComicCharacter(){
//     if (tipoComicCharacter.value === 'comic'){
//         styleCardComics();
//     }
// }

function styleCardComics(characters){
    ...
    characters.forEach(character => {
        ...
        if (character.images.length > 0){
            ...
            image.src = character.images[0].path + '.' + character.images[0].extension;
        }
        
        tittle.textContent = character.title;
